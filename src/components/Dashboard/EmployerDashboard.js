 ...
 * Displays summary cards, employee management, budget requests, and activity log.
 * Pending now refers to budget requests from employees.
 */
        ...
        <div className="dashboard-main">
          ...
          <div className="dashboard-grid">
            ...
            <div className="dashboard-card card-white">
              ...
              <div className="card-value value-indigo">{stats.totalEmployees}</div>
            ...
            <div className="dashboard-card card-indigo">
              ...
              <div className="card-value value-white">${stats.totalBudget.toLocaleString()}</div>
            ...
            <div className="dashboard-card card-white">
              ...
              <div className="card-value value-indigo">${stats.totalSpent.toLocaleString()}</div>
              <div className="card-subtitle">{budgetPercentage}% of total budget</div>
            </div>

            {/* Pending Budget Requests Card */}
            <div className="dashboard-card card-white">
              <div className="card-header">
                <span className="card-title">Budget Requests</span>
              ...
              <div className="card-value value-yellow">${stats.pendingApproval.toLocaleString()}</div>
              <div className="card-subtitle">Awaiting review</div>
            </div>
          </div>

          {/* Budget Requests Section */}
          <BudgetRequests onAction={handleRefresh} />
